...
roles and GAE. `OPDTrainer` inherits from the policy-only loop and overrides
batch assembly to include a frozen teacher model for on-policy distillation.
"""
...
__all__ = ["DPOTrainer", "OPDTrainer", "PolicyOnlyTrainer", "PPOTrainer", "SFTTrainer"]